...
namespace Worldex.Web.Filters
{
    public class ModelValidationFilter : IActionFilter
    {
        ...
        {
            Console.WriteLine("Current Log: " + "ModelValidationFilter OnActionExecuting: " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
            if (!filterContext.ModelState.IsValid)
            {
                ...
                Console.WriteLine("Current Log: " + "ModelValidationFilter Complete: " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
            }
        }

        public void OnActionExecuted(ActionExecutedContext filterContext)
        {
            Console.WriteLine("Current Log: " + "ModelValidationFilter OnActionExecuted: " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
        }
