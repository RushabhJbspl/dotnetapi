...
using Worldex.Web.BackgroundTask;
using Worldex.Infrastructure.Services.FiatIntegrationService;
//using Worldex.Web.BackgroundTask;
...
namespace Worldex.Web
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (Configuration["AllowCors"] == "True" || string.IsNullOrEmpty(Configuration["AllowCors"]))
            {
                services.AddCors(o => o.AddPolicy("CorsPolicy", builder =>
                {
                    builder
                          .WithOrigins(Configuration.GetValue<string>("CorsOrigins").Split(",", StringSplitOptions.RemoveEmptyEntries))
                         .AllowAnyHeader()
                         .WithMethods("GET", "POST", "DELETE", "PUT")
                         .AllowCredentials();
                }));
            ...
            //added for test rabbitmq message publishing for MarketMaker project -sahil 16-10-2019 03:19 PM
            ...
            container.Configure(config =>
            {
              ...
              //  config.For(typeof(IArbitrageWalletServiceGUID)).Add(typeof(ArbitrageWalletServiceGUID));
               ...
               // config.For(typeof(IArbitrageSPRepositories)).Add(typeof(ArbitrageSPRepository));   //ntrivedi 06-06-2019     
                ...
                config.For(typeof(IFiatIntegration)).Add(typeof(FiatIntegrationService));
