    ...
    public class MarketCapService : IHostedService, IDisposable
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            try
            {
                ...
                _timer7 = new Timer(DoWorktReleaseProfitAmount, null, TimeSpan.Zero,
                TimeSpan.FromMinutes(5));

                _timer8 = new Timer(IEOCron, null, TimeSpan.Zero,
                TimeSpan.FromHours(1));

                _timer9 = new Timer(DoWorktFiatSellWithdraw, null, TimeSpan.Zero,
                TimeSpan.FromMinutes(2));

                _timer10 = new Timer(FiatBinnanceLTPChange, null, TimeSpan.Zero,
                TimeSpan.FromMinutes(5));

                _timer11 = new Timer(FiatPendingHashUpdate, null, TimeSpan.Zero,
               TimeSpan.FromMinutes(2));
        ...
        private void IEOCron(object state)
        {
            try
            {
                HelperForLog.WriteLogIntoFile("MarketCapService", "IEOCron", "IEOCron At : " + Helpers.UTC_To_IST());
                _mediator.Send(new IEOCallSP { strIEOCallSPTemp = "" });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "An unexpected exception occured,\nMethodName:" + System.Reflection.MethodBase.GetCurrentMethod().Name + "\nClassname=" + this.GetType().Name, Microsoft.Extensions.Logging.LogLevel.Error);
        ...
        private void DoWorktReleaseProfitAmount(object state)
        {
            try
            {
                _mediator.Send(new ReleaseProfitAmountReq { Hour = 0 });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "An unexpected exception occured,\nMethodName:" + System.Reflection.MethodBase.GetCurrentMethod().Name + "\nClassname=" + this.GetType().Name, Microsoft.Extensions.Logging.LogLevel.Error);
        ...
        private void DoWorktFiatSellWithdraw(object state)
        {
            try
            {
                _mediator.Send(new FiatSellWithdrawReq { Hour = 0 });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "An unexpected exception occured,\nMethodName:" + System.Reflection.MethodBase.GetCurrentMethod().Name + "\nClassname=" + this.GetType().Name, Microsoft.Extensions.Logging.LogLevel.Error);
        ...
        public Task StopAsync(CancellationToken cancellationToken)
        {
            try
            {
                ...
                _timer7?.Change(Timeout.Infinite, 0);
                _timer8?.Change(Timeout.Infinite, 0);
                _timer9?.Change(Timeout.Infinite, 0);
                _timer10?.Change(Timeout.Infinite, 0);
        ...
        private void FiatBinnanceLTPChange(object state)
        {
            try
            {
                _mediator.Send(new FiatBinnanceLTPChange { Hour = 0 });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "An unexpected exception occured,\nMethodName:" + System.Reflection.MethodBase.GetCurrentMethod().Name + "\nClassname=" + this.GetType().Name, Microsoft.Extensions.Logging.LogLevel.Error);
        ...
        private void FiatPendingHashUpdate(object state)
        {
            try
            {
                _mediator.Send(new FiatPendingHashUpdate { Hour = 0 });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "An unexpected exception occured,\nMethodName:" + System.Reflection.MethodBase.GetCurrentMethod().Name + "\nClassname=" + this.GetType().Name, Microsoft.Extensions.Logging.LogLevel.Error);
