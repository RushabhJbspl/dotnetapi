    ...
    public class KYCController : ControllerBase
    {
        ...
        public async Task<IActionResult> PersonalVerification() //(PersonalVerificationViewModel model)
        {
            try
            {
                ...
                string CountryCode = await _userService.GetCountryByIP(HttpContext.Connection.RemoteIpAddress.ToString());
                ...
                //Rushabh 07-07-2020 As Per Client Ticket Added New Field
                if(string.IsNullOrEmpty(httpRequest["ValidIDCardNumber"].ToString()))
                    return BadRequest(new PersonalVerificationResponse { ReturnCode = enResponseCode.Fail, ReturnMsg = EnResponseMessage.ValidIDCardNumber, ErrorCode = enErrorCode.Status4128ValidIdentityCard });
                model.UserId = userid;
                ...
                model.ValidIDCardNumber = httpRequest["ValidIDCardNumber"].ToString();
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    if (userkycdata != null)
                    {
                        ...
                        userdata.ValidIDCardNumber = userkycdata.ValidIDCardNumber;
