...
using BackofficeWorldex.Web.ApiModels;
...
namespace BackofficeWorldex.Web.Api
{
    ...
    public class ToDoItemsController : Controller
    {
        ...
        [HttpPost("CreateDefaultWallet")]
        public async Task<IActionResult> CreateDefaultWallet([FromBody] WalletReqRes Request)
        {
            try
            {
