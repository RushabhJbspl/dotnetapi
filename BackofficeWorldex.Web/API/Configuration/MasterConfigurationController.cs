    ...
    public class MasterConfigurationController : Controller
    {
        ...
        public async Task<IActionResult> ChangeTemplateStatus(long Id, ServiceStatus Status)
        {
            ...
            try
            {
                ...
                {
                    var accessToken = await HttpContext.GetTokenAsync("access_token");
                    Response = _communicationService.DisableTemplateMaster(Id, Convert.ToInt16(Status),user.Id);
                }
                var respObj = JsonConvert.SerializeObject(Response);
                dynamic respObjJson = JObject.Parse(respObj);
                return Ok(respObjJson);
        ...
        public async Task<IActionResult> UpdateTemplateCategory(long TemplateType, ServiceStatus Status, long TemplateID)
        {
            ...
            try
            {
               ...
               ApplicationUser user = await _userManager.GetUserAsync(HttpContext.User);
                ...
                {
                    var accessToken = await HttpContext.GetTokenAsync("access_token");
                    Response = _communicationService.UpdateTemplateCategory(TemplateType, Convert.ToInt16(Status), TemplateID,user.Id);
                }
                var respObj = JsonConvert.SerializeObject(Response);
                dynamic respObjJson = JObject.Parse(respObj);
                return Ok(respObjJson);
        ...
        public async Task<IActionResult> GetWalletLedgerv2(DateTime FromDate, DateTime ToDate, string WalletId, int Page, int PageSize)
        {
            ...
            try
            {
                ...
                {
                    var accessToken = await HttpContext.GetTokenAsync("access_token");
                    Response = _communicationService.GetWalletLedgerv2(FromDate, ToDate, WalletId, Page, PageSize);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> WithdrawalReport(DateTime FromDate, DateTime ToDate, int PageNo, int PageSize, string CoinName, long? UserID, short? Status, string Address, string TrnID, string TrnNo, long? OrgId, short? IsInternalTransfer)
        {
            ...
            try
            {
                ...
                {
                    Response = _masterConfiguration.WithdrawReport(FromDate, ToDate, PageNo, PageSize, CoinName, UserID, Status, Address, TrnID, TrnNo, OrgId, IsInternalTransfer);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        [HttpGet("{FromDate}/{ToDate}/{PageNo}/{PageSize}")]
        public async Task<IActionResult> WithdrawalReportv2(DateTime FromDate, DateTime ToDate, int PageNo, int PageSize, string CoinName, long? UserID, short? Status, string Address, string TrnID, string TrnNo, long? OrgId, short? IsInternalTransfer)
        {
            ...
            try
            {
                ...
                {
                    Response = _masterConfiguration.WithdrawReportv2(FromDate, ToDate, PageNo, PageSize, CoinName, UserID, Status, Address, TrnID, TrnNo, OrgId, IsInternalTransfer);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        [HttpGet("{FromDate}/{ToDate}/{PageNo}/{PageSize}")]
        public async Task<IActionResult> DepositionReportv2(DateTime FromDate, DateTime ToDate, int PageNo, int PageSize, string CoinName, long? UserID, short? Status, string Address, string TrnID, long? OrgId)
        {
            ...
            try
            {
                ...
                {
                    Response = _masterConfiguration.DepositReportv2(FromDate, ToDate, PageNo, PageSize, CoinName, UserID, Status, Address, TrnID, OrgId);
        ...
        [HttpGet]//"GetEmailSMSAPIManagerCount"
        public async Task<IActionResult> GetEmailSMSAPIManagerCount()
        {
            EmailSMSCountData res = new EmailSMSCountData();
            try
            {
                ApplicationUser user = await _userManager.GetUserAsync(HttpContext.User);            
                if (user == null)
                ...
                {
                    res = _communicationService.GetEmailSMSAPIManagerCountData();                    
                }
                return Ok(res);
            }
            catch (Exception ex)
