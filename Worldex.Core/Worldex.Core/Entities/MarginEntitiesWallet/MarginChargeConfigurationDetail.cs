...
{
    public class MarginChargeConfigurationDetail : BizBase
    {
        [Required]
    ...
    public class ArbitrageChargeConfigurationDetail : BizBase
    {
        [Required]
        public long ChargeConfigurationMasterID { get; set; }
        ...
        [Required]
        public short MarkUpValueType { get; set; }//(1.Fixed,2.Percentage)
