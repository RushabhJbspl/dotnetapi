namespace Worldex.Core.Enums
{
    public class EnResponseMessage
    {
        ...
        public static string DeviceAuthPreferenceAlreadyActivated = "You have already activated Device Authorization.";
        public static string DeviceAuthPreferenceAlreadyDeactivated = "You have already Deactivated Device Authorization.";
        public static string SuccessfullUpdateDeviceAuthPreference = "Your Device Authorization updated successfully.";
        ...
        public static string CreateTrn_CheckWithdrawBeneficiary_Fail = "CheckWithdrawBeneficiary Fail";
        public static string ProcessTrn_AmountBetweenMinMaxMsg = "Amount Must be Between: @MIN AND @MAX";
        public static string ProcessTrn_TotalFailure = "price * quantity Must be Between: @MIN AND @MAX";
        public static string ProcessTrn_PriceBadPrecision = "Price Precision is over the maximum defined for the market.";
        public static string ProcessTrn_QtyBadPrecision = "Quantity Precision is over the maximum defined for the market.";
        public static string ProcessTrn_AmtBadPrecision = "Notional Precision is over the maximum defined for the market.";
        ...
        public static string ProcessTrn_ArbitrageFirstTransactionFail = "Smart Arbitrage First Transaction Fail";
        public static string OrderTypeNotAvailable = "Currently This Order type not available ";
        //============================
        ...
        //============================walelt=================================//  
        public static string FiatBankIdRequired = "Please Enter Required Parameter Bank ID";
        public static string FiatInvalidBankId = "Please Provide A Valid Bank ID";
        public static string PrevReqAlreadyInProcess = "Your Previous Request Is Already In Process";
        public static string MultipleRequestNotAllowed = "You Can Not Add Multiple Bank Details";
        ...
        public static string InvalidChargeConfigurationMasterID = "Invalid ChargeConfigurationMasterID.";
        ...
        public static string RequestAccepted = "Request Accepted Successfully!";
        public static string RequestRejected = "Request Rejected Successfully!";
        public static string RequestNotPending = "The Given Request Is Not Pending!";
        ...
        public static string SelfAddressFound = "You are not allowed to whitelist yor own address!";
        ...
        public static string InvalidTrnNo = "Invalid TrnNo.";
        ...
        public static string InvalidKYCStatus = "You Can Not Proceed As Your KYC Is Incomplete";
        public static string FiatNonKYC = "Non KYC Users Are Not Allowed To Add Bank Detail!";
        public static string FiatInvalidMinLimit = "Minimum Limit Must Be Less Or Equal To Maximum Limit.";
        //ntrivedi 07-06-2019
        ...
        public static string InvalidFromDate_ToDate = "Inavlid Date Selection";
        //========================My Account===============================//
        ...
        public static string LoginWithPassword = "Provide Password to Login.";
        ...
        public static string SignUpWithResendEmail = "Otp resend successfully send in your email id.";
        public static string SignUpWithResendMobile = "Otp resend successfully send in your mobile.";
        ...
        public static string Passwordmatch = " New password alradey exit,please Enter different password";
        public static string Invalidlinkdata = "Invalid LinkData";
        ...
        public static string ValidIDCardNumber = "Please Enter Valid ID Card Number";
        ...
        public static string AuthorizedLinkBlank = "This authorized code can't be blank.";        
        ...
        public static string UnAuthorizedIP = "Your IP Address Is Unfamiliar. For Security Reasons, The Confirmation Mail Has Been Sent To Your Registered Mail.";
        public static string AuthorizedIPSuccessfully = "New IP Address Is Authorized Successfully.";
        // ================================ SignalR ========================= //
        //for Wallet
        ...
        public static string WithdrawConfirmationRefNoRequired = "Required Parameters Can Not Be Empty Or Null.";
        public static string WithdrawConfirmationInvalidRefNo = "Invalid Reference No.";
        public static string WithdrawConfirmationLinkDecryptionFail = "Invalid Request Data";
        public static string WithdrawConfirmationReqDataIsNull = "Request Data Not Found.";
        public static string WithdrawConfirmationUserNotFound = "User Not Found";
        // My Account
        ...
        public static string UserIsBlocked = "Your Account Is Blocked, You Can Not Log In!!";
        // Chat service///
        ...
        public static string SuccessfullUpdateUserTheme = "Your  Theme mode updated successfully.";
        ...
        public static string AddPasswordPolicy = "Password Policy Added successfully."; /*"Successfully add password policy configuration."; Change Add Message By Rushali(19-12-2019)*/
        public static string SuccessupdatePasswordPolicy = "Password Policy Updated successfully.";/*"Successfully updated password policy configuration.";Change Update Message By Rushali(19-12-2019)*/
        public static string updatePasswordPolicy = "Password policy configuration not updated successfully.";
        public static string SuccesseDeletePasswordPolicy = "Password Policy Deleted successfully.";/*"Successfully delete password policy configuration.";Change Delete Message By Rushali(19-12-2019)*/
        public static string DeletePasswordPolicy = "Password policy configuration not deleted successfully.";
        public static string PasswordPolicyGet = "Record Found Successfully";/* "Successfully get password policy configuration.";Change Get Message By Rushali(19-12-2019)*/
        ...
        public static string CanNotUpdateDisableUser = "This Account Is Not Active You Can Not Update Its Detail";
        ...
        public static string SuccessInviteUser = "Your account is activated successfully, Reset password link has been sent in your mail.";
        public static string InvalidUserIdv1 = "User Id Not valid";
        ...
        public static string Enable_Auto_Copy_Trade_Functionality = "Please select valid auto copy trade option."; // 7009             public static string SuccessFullUpDateFollowerAdminProfile = "Successfully update follower profile setting.";
        ...
        public static string chargeConfigurationMasterArbitrageAlreadyExists = "Charge Configuration Master Already Exists";
        public static string InvalidKYCComplaint = "Invalid KYCComplaint";
        public static string ChargeConfigurationMasterArbitrageDataFetchFail = "No Record found.";
        public static string RecordAlreadyExists = "Record Already Exists";
        // khushali 26-06-2019 arbitrage trading
        public static string Binance_PRICE_FILTER = "Price is too high, too low, and/or not following the tick size rule for the Binance market.";
        public static string Binance_PERCENT_PRICE = "Price is too high or too low from the average weighted price for the Binance market.";
        public static string Binance_LOT_SIZE = "quantity is too high, too low, and/or not following the step size rule for the Binance market.";
        public static string Binance_MIN_NOTIONAL = "price * quantity is too low to be a valid order for the Binance market.";
        public static string Binance_ICEBERG_PARTS = "ICEBERG order would break into too many parts. icebergQty is too small for the Binance market.";
        public static string Binance_MARKET_LOT_SIZE = "MARKET order's quantity is too high, too low, and/or not following the step size rule for the symbol.";
        public static string Binance_MAX_NUM_ORDERS = "Account has too many open orders on the symbol.";
        public static string Binance_MAX_ALGO_ORDERS = "Account has too many open stop loss and/or take profit orders on the symbol.";
        public static string Binance_MAX_NUM_ICEBERG_ORDERS = "Account has too many open iceberg orders on the symbol.";
        public static string Binance_EXCHANGE_MAX_NUM_ORDERS = "Account has too many open orders on the exchange.";
        public static string Binance_EXCHANGE_MAX_ALGO_ORDERS = "Account has too many open stop loss and/or take profit orders on the exchange.";
        public static string Binance_Timeout = "Service Provider Timeout for the Binance market.";
        public static string Bittrex_MIN_TRADE_REQUIREMENT_NOT_MET = "Trade Requirment not met for the Bittrex market.";
        public static string Bittrex_INSUFFICIENT_FUNDS = "Service provider unavailable for the Bittrex market.";
        public static string Tradesatoshi_INSUFFICIENT_FUNDS = "Service provider unavailable for the Tradesatoshi market.";
        public static string Binance_INSUFFICIENT_FUNDS = "Service provider unavailable for the Binance market.";
        public static string Bitfinex_INSUFFICIENT_FUNDS = "Service provider unavailable for the Bitfinex market";
        public static string Bitfinex_MIN_TRADE_REQUIREMENT_NOT_MET = "Trade Requirment not met for the Bitfinex market.";
        //Kraken Error Message for Kraken Exchange by Pushpraj as on 11-07-2019
        public static string Kraken_INVALID_ARGUMENTS = "Invalid Arguments passing in request for Kraken.";
        public static string Kraken_UNAVAILABLE = "Currently Kraken is Unavailable.";
        public static string Kraken_INVALID_REQUEST = "Invalid Request passing for Kraken.";
        public static string Kraken_CANNOT_OPEN_POSITION = "Can not open position for Kraken.";
        public static string Kraken_CANNOT_OPEN_OPPOSING_POSITION = "Can not open opposing position for Kraken";
        public static string Kraken_MARGIN_ALLOWED_EXCEEDED = "Margin Allowed Exceeded for Kraken.";
        public static string Kraken_MARGIN_LEVEL_TO_LOW = "Margin level is to low for Kraken.";
        public static string Kraken_INSUFFICIENT_MARGIN = "Insufficient Margin for Kraken.";
        public static string Kraken_INSUFFICIENT_FUNDS = "Insufficient Funds for Kraken.";
        public static string Kraken_ORDER_MINIMUM_NOT_MET = "Minimun Order not met for Kraken.";
        public static string Kraken_ORDER_LIMIT_EXCEEDED = "Order limit has been exceeded for Kraken.";
        public static string Kraken_POSITION_LIMIT_EXCEEDED = "Position limit has been exceeded for Kraken.";
        public static string Kraken_RATE_LIMIT_EXCEEDED = "Rate limit has been exceeded for Kraken.";
        public static string Kraken_SCHEDULE_ORDER_LIMIT_EXCEEDED = "Schedule Order limit has been exceeded for Kraken.";
        public static string Kraken_UNKNOWN_POSITION = "Unknown Postion  of Order for Kraken.";
        //2019-7-25 vsolanki added new errormsg
        public static string SameEMail = "You are not allowed to request with your own Email!";
        public static string EmailVerifyPending = "This email verify pending.";
        public static string Status4189InValidReferralCode = "Please provide a valid Referral Code.";
        public static string Status14214UserCreatedTimeNotValid = "User can withdraw transaction after Six hours from registration time";

        // Create Response Message By Rushali (24-12-2019)
        public static string PassDataNotFound = "Pass Data Not Found";
        public static string DataNotInsert = "Data Not Insert";
        public static string InvalidId = "Invalid Id";

        //add by akshay kothari 13/02/2020
        public static string FileCreateSuccessfully = "File Created Successfully";
