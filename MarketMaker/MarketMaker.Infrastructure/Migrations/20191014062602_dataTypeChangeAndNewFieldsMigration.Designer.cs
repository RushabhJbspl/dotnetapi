...
namespace MarketMaker.Infrastructure.Migrations
{
    ...
    [Migration("20191014062602_dataTypeChangeAndNewFieldsMigration")]
    partial class dataTypeChangeAndNewFieldsMigration
    {
            ...
            modelBuilder.Entity("MarketMaker.Domain.Entities.MarketMakerPreference", b =>
                {
                    ...
                    b.Property<decimal>("BuyHoldOrderRateChange")
                        .HasColumnType("decimal(28,18)");
                    ...
                    b.Property<decimal>("SellHoldOrderRateChange")
                        .HasColumnType("decimal(28,18)");
